...
## Installing the extension via Stores!
Our Extension is Availabe for both Gecko & Chromium-based browsers. Install it from the following stores:
- [Chrome](https://chromewebstore.google.com/detail/movie-web-remastered-exte/nbcjlcokgigjfhejofmbaomcimggiafn)
- [Firefox](https://addons.mozilla.org/en-US/firefox/addon/pstream-extension/)

<Warning>Disclaimer, for Chrome, the extension is movie-web remastered, functionally they are the same, just different branding.</Warning>
