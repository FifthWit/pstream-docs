...
If you are downloading the P-Stream `zip` files from our GitHub and installing them on a static website host, then all you need to do is to make sure to download the [`P-Stream.pwa.zip`](https://github.com/sussy-code/smov/releases/latest/download/sudo-flix.pwa.zip) file instead of the `P-Stream.zip` file!
