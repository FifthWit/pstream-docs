...
<Steps>
  <Steps.Step>
    Click [here](https://github.com/Pasithea0/smov/fork) to fork the P-Stream Github repository
  </Steps.Step>
...
<Steps>
  <Steps.Step>
    [Fork P-Stream](https://github.com/Pasithea0/smov/fork) on Github.
  </Steps.Step>
  ...
  <Steps.Step>
    Give your project a silly name and select `production` as the production branch.
    <Note>If you want your instance to have the newest features, select the `beta` branch.</Note>
  </Steps.Step>
...
<Steps>
  <Steps.Step>
    Download the file `pstream.zip` from the latest release: https://github.com/Pasithea0/smov/releases/latest.
  </Steps.Step>
